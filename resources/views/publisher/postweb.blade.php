                ...
                <div class="tab-pane fade" id="step2">
                    <div  class="col-md-10 ">
                        ...
                        <div  class="step">
                            ...
                            <div class="text-end mt-2">
                                <button type="button" onclick="goToNextStep(3)" class="btn btn-danger">Next <i class="ri-arrow-right-line fw-bold"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="step3">
                    <div id="verifyStep" class="col-md-10">
                        ...
                        <div id="step3Content" class="step">
                            ...
                            <div class="text-end mt-2">
                                <button type="button" onclick="goToNextStep(4)" class="btn btn-danger">Next <i class="ri-arrow-right-line fw-bold"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function validateUrlAndProceed() {
            ...
            if (urlInput.startsWith("https://")) {
                ...
                setTimeout(function() {
                    ...
                    // Activate corresponding tab
                    document.getElementById('nav-step2-tab').classList.add('active');
                    // Hide loading circle
