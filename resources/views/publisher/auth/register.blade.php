                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free backlinks account now</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate method="POST"
                                        ...
                                        <div class="mb-3">
                                        <label for="choices-privacy-status-input" class="form-label">Select Role</label>
                                            <select class="form-select"
                                                id="choices-privacy-status-input" name="role">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> Backlinks Platform. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by HiddenLogics</p>
                        </div>
                    </div>
                </div>
            </div>
